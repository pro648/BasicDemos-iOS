...
class ViewController: UIViewController {
    ...
    override func loadView() {
        let backView = BackgroundView(frame: UIScreen.main.bounds)
        view = backView
    }
...
//        view.backgroundColor = UIColor(red: 255.0 / 255.0, green: 255.0 / 255.0, blue: 102.0 / 255.0, alpha: 1.0)
    ...
    private lazy var medalView: MedalView = {
        let view = MedalView(frame: .zero)
        return view
    }()
}
...
extension ViewController {
    private func addAllSubviews() {
        ...
        counterView.addSubview(medalView)
    }
    ...
    private func makeAllConstraints() {
        ...
        NSLayoutConstraint.activate([
            medalView.centerXAnchor.constraint(equalTo: counterView.centerXAnchor),
            medalView.bottomAnchor.constraint(equalTo: counterView.bottomAnchor),
            medalView.widthAnchor.constraint(equalToConstant: 80),
            medalView.heightAnchor.constraint(equalToConstant: 80)
        ])
    }
